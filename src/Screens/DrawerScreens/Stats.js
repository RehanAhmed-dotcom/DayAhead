...
const Stats = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      onPress={() => navigation.navigate('StatsDetail', { item })}
      style={{
        height: 'auto',
        padding: 15,
        width: '47%',
  ...
  const { top } = useSafeAreaInsets();
  const data = [
    { name: 'Learning & Growth', image: require('../../Assets/Clean.png') },
    { name: 'Urgent Tasks', image: require('../../Assets/Healthy.png') },
    {
      name: 'Creativity & Inspiration',
      image: require('../../Assets/Morning.png'),
    },
    { name: 'Productivity Task', image: require('../../Assets/Relation.png') },
    { name: 'Self-Improvement', image: require('../../Assets/Sleep.png') },
    {
