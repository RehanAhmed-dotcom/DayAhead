...
import { useSafeAreaInsets } from 'react-native-safe-area-context';
  ...
  const FormJournal4 = ({ navigation,route }) => {
    const {gratitudedata,believesdata,goals}= route.params
        ...
        <View
            ...
            >
              <TextInput
                ...
                value={oneStep}
                onChangeText={setOneStep}
              />
            </View>
      
        <TouchableOpacity onPress={()=>navigation.navigate('FormJournal5',{gratitudedata,believesdata,goals,oneStep})} style={[styles.btnView,{backgroundColor:Colors.mainColor,marginTop:wp(15),marginBottom:wp(4)}]}  activeOpacity={0.7}>
