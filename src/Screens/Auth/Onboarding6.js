...
const Onboarding6 = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.white,paddingTop: Platform.OS === 'ios' ? 10 : 0 }}>
      ...
      <TouchableOpacity  onPress={() => navigation.navigate('Onboarding7')} style={{backgroundColor: Colors.white, width: wp(10),alignItems:"center",justifyContent:"center", height: wp(10), borderRadius: wp(5), elevation:3 }}>
