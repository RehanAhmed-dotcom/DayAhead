    ...
    <View style={{ flex: 1, backgroundColor: Colors.white,paddingTop: Platform.OS === 'ios' ? 10 : 0 }}>
      ...
      />
        ...
        >
          ...
          >
            Your Personal Growth Score Starts Now
          </Text>
        </View>
        ...
        >
          ...
          >
            Every verified action builds your Productivity Score — like a credit
            score for your habits. Wake up on time, plan your day, work out,
            meditate, and watch your score climb toward 900.
          </Text>
        </View>
      </View>
      ...
      <TouchableOpacity  onPress={() => navigation.navigate('Onboarding3')} style={{backgroundColor: Colors.white, width: wp(10),alignItems:"center",justifyContent:"center", height: wp(10), borderRadius: wp(5), elevation:3 }}>
