...
const Subscription = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      <Text
        style={{ fontSize: 22, fontFamily: fonts.bold, color: Colors.white }}
      >
        ${item.price}
        <Text
          style={{
              ...
              {isloading ? (
                ...
                >
                  ...
                  <View style={{ marginTop: wp(10) }}>
                    ...
                    >
                      ...
                      >
                        ${mySubscription.data.plan.amount / 100}
                      </Text>
                      /{mySubscription.data.plan.interval} plan
                    </Text>
                  </View>
                  <TouchableOpacity
                    style={{
                  ...
                  >
                    <View style={styless.overlay}>
                      <View style={styless.container}>
                        <Text style={styless.title}>Cancel Subscription</Text>
                ...
                <View>
                  ...
                  <View style={{ marginTop: wp(7), marginHorizontal: wp(5) }}>
                    ...
                    >
                      Start with the 7-day free trial. After the trial, the
                      selected plan will be auto-charged, and the user can
