    ...
    <View style={{ flex: 1, backgroundColor: Colors.white,paddingTop: Platform.OS === 'ios' ? 10 : 0 }}>
      ...
      />
        ...
        >
          ...
          >
            The Most Efficient and Productive You{'\n'}
            Starts Today
          </Text>
        </View>
      ...
      <TouchableOpacity  onPress={() => dispatch(setOnboarding())} style={{backgroundColor: Colors.white, width: wp(10),alignItems:"center",justifyContent:"center", height: wp(10), borderRadius: wp(5), elevation:3 }}>
