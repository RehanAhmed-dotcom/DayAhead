            ...
            {[0].map(index => (
              ...
              >
                <Image
                  ...
                  // tintColor={'white'}
                  style={{
                    width: selectedImages[index] ? wp(90) : 33,
                    height: selectedImages[index] ? 160 : 33,
            ...
            >
              <Text
                style={{
                  fontSize: 14,
                  fontFamily: fonts.regular,
                  color: selectedMembers.length > 0 ? Colors.white : 'white',
                  width: wp(70),
                }}
              >
              ...
              <TouchableOpacity onPress={() => setModalVisibleMember(true)}>
                <AntDesign name="right" color={Colors.white} size={18} />
              </TouchableOpacity>
            </TouchableOpacity>
          </View>
          <View
